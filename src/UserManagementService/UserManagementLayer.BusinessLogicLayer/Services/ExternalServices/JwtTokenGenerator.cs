    ...
    namespace UserManagementService.BusinessLogicLayer.Services.ExternalServices
    {
        public class JwtTokenGenerator : IJwtTokenGenerator
        {
            ...
            public JwtTokenGenerator(IOptions<JwtSettings> jwtSettings)
            {
                ...
                {
                    Console.WriteLine("HereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHereHere: " + jwtSettings.Value.Issuer + jwtSettings.Value.ExpiryMinutes);
                    throw new ArgumentException("JWT Secret is not configured" + jwtSettings.Value.Issuer);
                }
